...
local utils = require('galaxyline.condition')
...
local buffer_not_empty = function() return utils.buffer_not_empty() end

local checkwidth = function()
    return utils.hide_in_width(40) and buffer_not_empty()
end
